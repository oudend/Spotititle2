    ...
    <div className="overflow-hidden">
      ...
      <main className="flex text-xl text-zinc-400 min-h-screen flex-col items-center pl-[300px] overflow-visible">
        ...
        <ImageDropdownInput
          ...
          onFileSelect={async (option) => {
            // const currentBackground: ImageInputOptionsProps | null =
            //   await store.get("background");
            // await store.set("background", option);
            // eventBus.dispatch("backgroundUpdate", option);
            // console.log("LOOOK HERE");
            // if (currentBackground !== null && option.label === currentBackground.label)
            //   return;
          }}
          minFilenameLength={3}
